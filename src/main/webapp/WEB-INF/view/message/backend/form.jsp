...
<title>内容列表页面</title>
<link href="<%=path%>/resources/message/css/all.css" rel="stylesheet"
	type="text/css" />
<script src="<%=path%>/resources/message/js/common/jquery-1.8.0.min.js"></script>
<script src="<%=path%>/resources/message/js/back/list.js"></script>
</head>
